...
export function BentoCanvas() {
  const { head, ghost, stage } = useAnalysis()
  ...
  return (
    ...
    >
      <DotField className="pointer-events-none absolute inset-0 -z-10 opacity-90" />
      <div
        ...
        <div style={{ gridArea: 'eod' }}>
          ...
          >
            <Wave
              ...
              ghost={ghost ? spread(head.panels.eod.value, 12) : null}
            />
          </Panel>
        </div>
